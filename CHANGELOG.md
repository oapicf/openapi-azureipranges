...
- Change test specification version 20260817

## 1.0.0 - 2026-01-31
### Added
- Add ruby test
- Add application/octet-stream response handler

### Changed
- Upgrade Swaggy C to 5.1.0
- Upgrade OpenAPI Generator to 7.18.0
- Shift URL to https://download.microsoft.com/download/7/1/d/71d86715-5596-4529-9b13-da13a5de5b63
- Change test specification version 20260126
- Modify build-ruby to not immediately fail application/octet-stream
