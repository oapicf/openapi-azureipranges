...
defmodule AzureIPRangesAndServiceTags-PublicCloud.Connection do
  @moduledoc """
  Handle Tesla connections for AzureIPRangesAndServiceTags-PublicCloud.

  Additional middleware can be set in the compile-time or runtime configuration:

      config :tesla, AzureIPRangesAndServiceTags-PublicCloud.Connection,
  ...
  The default base URL can also be set as:
      ...
      config :azure_ip_ranges_and_service_tags_public_cloud,
        :base_url, "https://download.microsoft.com/download/7/1/d/71d86715-5596-4529-9b13-da13a5de5b63"
  """
  ...
  @doc """
  Configure a AzureIPRangesAndServiceTags-PublicCloud client.

  ### Parameters

  - `options`: an optional keyword list of AzureIPRangesAndServiceTags-PublicCloud.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:azure_ip_ranges_and_service_tags_public_cloud, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - AzureIPRangesAndServiceTags-PublicCloud 1.0.0 - elixir"
        )
      )
