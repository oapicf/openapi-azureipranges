...
defmodule AzureIPRangesAndServiceTags-PublicCloud.RequestBuilder do
  @moduledoc """
  ...
  defp decode(%Tesla.Env{body: body}, %{}) do
    AzureIPRangesAndServiceTags-PublicCloud.Deserializer.json_decode(body)
  end

  defp decode(%Tesla.Env{body: body}, module) do
    AzureIPRangesAndServiceTags-PublicCloud.Deserializer.json_decode(body, module)
  end
end
