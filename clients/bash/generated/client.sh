...
#
# This is a Bash client for Azure IP Ranges and Service Tags - Public Cloud.
#
# LICENSE:
# 
#
...
${BOLD}${WHITE}Azure IP Ranges and Service Tags - Public Cloud command line client (API version 1.0.1-pre.0)${OFF}
...
echo -e "              \\t\\t\\t\\t(e.g. 'https://download.microsoft.com')"
...
print_about() {
    echo ""
    echo -e "${BOLD}${WHITE}Azure IP Ranges and Service Tags - Public Cloud command line client (API version 1.0.1-pre.0)${OFF}"
    echo ""
    echo -e "License: MIT"
...
print_version() {
    echo ""
    echo -e "${BOLD}Azure IP Ranges and Service Tags - Public Cloud command line client (API version 1.0.1-pre.0)${OFF}"
    echo ""
}
