...
has version_info => ( is => 'ro',
                      isa => 'HashRef',
                      default => sub { {
                          app_name => 'Azure IP Ranges and Service Tags - Public Cloud',
                          app_version => '0.10.1-pre.0',
...
=head2 Azure IP Ranges and Service Tags - Public Cloud version: 0.10.1-pre.0
