...
OpenapiAzureipranges - JavaScript client for openapi_azureipranges
...
------------ | ------------- | ------------- | -------------
*OpenapiAzureipranges.DefaultApi* | [**getAzureIpRangesServiceTagsPublicCloud**](docs/DefaultApi.md#getAzureIpRangesServiceTagsPublicCloud) | **GET** /ServiceTags_Public_{version}.json | Get Azure IP Ranges and Service Tags - Public Cloud


## Documentation for Models

 - [OpenapiAzureipranges.Change](docs/Change.md)
 - [OpenapiAzureipranges.Value](docs/Value.md)
 - [OpenapiAzureipranges.ValueProperties](docs/ValueProperties.md)
