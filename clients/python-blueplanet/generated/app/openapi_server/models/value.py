...
from app.openapi_server.models.value_properties import ValueProperties  # noqa: F401,E501
...
class Value(Model):
    ...
    def __init__(self, name: str=None, id: str=None, properties: ValueProperties=None):  # noqa: E501
