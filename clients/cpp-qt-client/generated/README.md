...
void Example::exampleFunction1(){
     OAIDefaultApi apiInstance;
      ...
      QEventLoop loop;
      connect(&apiInstance, &OAIDefaultApi::getAzureIpRangesServiceTagsPublicCloudSignal, [&]() {
          loop.quit();
      });
      connect(&apiInstance, &OAIDefaultApi::getAzureIpRangesServiceTagsPublicCloudSignalE, [&](QNetworkReply::NetworkError, const QString &error_str) {
          qDebug() << "Error happened while issuing request : " << error_str;
          loop.quit();
      });

      QString version = create(); // QString | The version of the JSON file to be retrieved in the format YYYYMMDD, e.g. 20240506
