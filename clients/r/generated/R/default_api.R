...
DefaultApi <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return Change
    GetAzureIpRangesServiceTagsPublicCloud = function(version, data_file = NULL, ..., .parse = TRUE) {
      local_var_response <- self$GetAzureIpRangesServiceTagsPublicCloudWithHttpInfo(version, data_file = data_file, ..., .parse = .parse)
    ...
    GetAzureIpRangesServiceTagsPublicCloudWithHttpInfo = function(version, data_file = NULL, ..., .parse = TRUE) {
      args <- list(...)
      query_params <- list()
      header_params <- c()
      form_params <- list()
      ...
      local_var_accepts <- list("application/json", "application/octet-stream")
