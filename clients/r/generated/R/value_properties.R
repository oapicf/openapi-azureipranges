...
ValueProperties <- R6::R6Class(
  ...
  public = list(
    ...
    #'
    #' @return ValueProperties as a base R list.
    #' @examples
    #' # convert array of ValueProperties (x) to a data frame
    #' \dontrun{
    #' library(purrr)
    #' library(tibble)
    ...
    #' @description
    #' Convert ValueProperties to a base R type
    #'
