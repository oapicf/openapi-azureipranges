...
Change::Change(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Change::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Change::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Change");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Change::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_CloudIsSet) {
            object["cloud"] = JsonValueConverter<std::string>::toJsonValue(getCloud());
        }
        if (m_ValuesIsSet) {
            object["values"] = JsonValueConverter<std::vector<std::shared_ptr<Value>>>::toJsonValue(getValues());
        }
    return object;
}

void Change::fromJsonObject_internal(boost::json::object const& object)
{
    ...
    {
        const auto CloudIt = object.find("cloud");
        if (CloudIt != object.end()) {
            setCloud(JsonValueConverter<std::string>::fromJsonValue(CloudIt->value()));
        }
    }
    {
        const auto ValuesIt = object.find("values");
        if (ValuesIt != object.end()) {
            setValues(JsonValueConverter<std::vector<std::shared_ptr<Value>>>::fromJsonValue(ValuesIt->value()));
        }
    }
}
...
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Change>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Change>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Change>>>::fromJsonValue(boost::json::parse(json));
}
