...
Value::Value(boost::json::value const& value)
{
    fromJsonValue(value);
}
...
boost::json::value Value::toJsonValue() const
{
    return boost::json::value(toJsonObject_internal());
}

void Value::fromJsonValue(boost::json::value const& value)
{
    if (!value.is_object()) {
        throw std::invalid_argument("Expected a JSON object for Value");
    }
    fromJsonObject_internal(value.as_object());
}

boost::json::object Value::toJsonObject_internal() const
{
    boost::json::object object;
        ...
        if (m_PropertiesIsSet) {
            object["properties"] = JsonValueConverter<std::shared_ptr<ValueProperties>>::toJsonValue(getProperties());
        }
    return object;
}

void Value::fromJsonObject_internal(boost::json::object const& object)
{
    m_NameIsSet = false;
    m_IdIsSet = false;
    ...
    }
    {
        ...
        if (PropertiesIt != object.end()) {
            setProperties(JsonValueConverter<std::shared_ptr<ValueProperties>>::fromJsonValue(PropertiesIt->value()));
        }
    }
}
...
std::string createJsonStringFromModelVector(const std::vector<std::shared_ptr<Value>>& data)
{
    return boost::json::serialize(JsonValueConverter<std::vector<std::shared_ptr<Value>>>::toJsonValue(data));
}

void createModelVectorFromJsonString(std::vector<std::shared_ptr<Value>>& vec, const std::string& json)
{
    vec = JsonValueConverter<std::vector<std::shared_ptr<Value>>>::fromJsonValue(boost::json::parse(json));
}
