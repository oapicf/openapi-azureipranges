        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    c.SwaggerDoc("0.10.1-pre.0", new OpenApiInfo
                    {
                        ...
                        Contact = new OpenApiContact
                        {
                            ...
                            Url = new Uri("https://github.com/oapicf/openapi-azureipranges"),
                    ...
                    c.DocumentFilter<BasePathFilter>("/download.microsoft.com/download/7/1/d/71d86715-5596-4529-9b13-da13a5de5b63");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/0.10.1-pre.0/openapi.json", "Azure IP Ranges and Service Tags - Public Cloud");

                    //TODO: Or alternatively use the original OpenAPI contract that's included in the static files
                    // c.SwaggerEndpoint("/openapi-original.json", "Azure IP Ranges and Service Tags - Public Cloud Original");
                });
            app.UseRouting();
