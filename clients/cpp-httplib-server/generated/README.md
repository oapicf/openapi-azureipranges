...
```cpp
// Create a model
auto model = models::Change();
model.setChangeNumber(/* value */);  // Set changeNumber
model.setCloud(/* value */);  // Set cloud
model.setValues(/* value */);  // Set values

// Serialize to JSON
nlohmann::json json = models::Change::toJson(model);
std::string jsonString = json.dump();

// Deserialize from JSON
auto parsedModel = models::Change::fromJson(nlohmann::json::parse(jsonString));
```
#### models::Value

```cpp
// Create a model
auto model = models::Value();
model.setName(/* value */);  // Set name
model.setId(/* value */);  // Set id
model.setProperties(/* value */);  // Set properties

// Serialize to JSON
nlohmann::json json = models::Value::toJson(model);
std::string jsonString = json.dump();

// Deserialize from JSON
auto parsedModel = models::Value::fromJson(nlohmann::json::parse(jsonString));
```
#### models::ValueProperties

```cpp
// Create a model
auto model = models::ValueProperties();
model.setChangeNumber(/* value */);  // Set changeNumber
model.setRegion(/* value */);  // Set region
model.setRegionId(/* value */);  // Set regionId
model.setPlatform(/* value */);  // Set platform
model.setSystemService(/* value */);  // Set systemService
model.setAddressPrefixes(/* value */);  // Set addressPrefixes
model.setNetworkFeatures(/* value */);  // Set networkFeatures

// Serialize to JSON
nlohmann::json json = models::ValueProperties::toJson(model);
std::string jsonString = json.dump();

// Deserialize from JSON
auto parsedModel = models::ValueProperties::fromJson(nlohmann::json::parse(jsonString));
```
...
public:
    ServiceTagsPublicversionjsonGetResponse handleGetForServiceTagsPublicversionjson(const ServiceTagsPublicversionjsonGetRequest& params) override {
        // Access request parameters:
        // Path: params.m_version

        // Implement your business logic here

        // Return success response (HTTP HTTP_RESPONSE_CODE_CHANGE):
        models::Change successResponse;
        // ... populate response ...
