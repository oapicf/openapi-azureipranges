...
module AzureIPRangesAndServiceTags-PublicCloud.Client where
...
dispatchLbs
  ...
  -> AzureIPRangesAndServiceTags-PublicCloudConfig -- ^ config
  -> AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept -- ^ request
...
runConfigLog
  :: P.MonadIO m
  => AzureIPRangesAndServiceTags-PublicCloudConfig -> LogExec m a
runConfigLog config = configLogExecWithContext config (configLogContext config)

-- | Run a block using the configured logger instance (logs exceptions)
runConfigLogWithExceptions
  :: (E.MonadCatch m, P.MonadIO m)
  => T.Text -> AzureIPRangesAndServiceTags-PublicCloudConfig -> LogExec m a
