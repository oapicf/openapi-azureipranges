...
module AzureIPRangesAndServiceTags-PublicCloud.Core where
...
-- * AzureIPRangesAndServiceTags-PublicCloudConfig

-- |
data AzureIPRangesAndServiceTags-PublicCloudConfig = AzureIPRangesAndServiceTags-PublicCloudConfig
...
-- | display the config
instance P.Show AzureIPRangesAndServiceTags-PublicCloudConfig where
  show c =
    T.printf
...
-- | constructs a default AzureIPRangesAndServiceTags-PublicCloudConfig
--
-- configHost:
--
...
-- configUserAgent:
--
-- @"azure-ip-ranges-and-service-tags---public-cloud/0.1.0.0"@
--
newConfig :: IO AzureIPRangesAndServiceTags-PublicCloudConfig
newConfig = do
    logCxt <- initLogContext
    return $ AzureIPRangesAndServiceTags-PublicCloudConfig
        { configHost = "https://download.microsoft.com/download/7/1/d/71d86715-5596-4529-9b13-da13a5de5b63"
        , configUserAgent = "azure-ip-ranges-and-service-tags---public-cloud/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => AzureIPRangesAndServiceTags-PublicCloudConfig -> auth -> AzureIPRangesAndServiceTags-PublicCloudConfig
addAuthMethod config@AzureIPRangesAndServiceTags-PublicCloudConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: AzureIPRangesAndServiceTags-PublicCloudConfig -> IO AzureIPRangesAndServiceTags-PublicCloudConfig
...
withStderrLogging :: AzureIPRangesAndServiceTags-PublicCloudConfig -> IO AzureIPRangesAndServiceTags-PublicCloudConfig
...
withNoLogging :: AzureIPRangesAndServiceTags-PublicCloudConfig -> AzureIPRangesAndServiceTags-PublicCloudConfig
withNoLogging p = p { configLogExecWithContext =  runNullLogExec}

-- * AzureIPRangesAndServiceTags-PublicCloudRequest
...
data AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept = AzureIPRangesAndServiceTags-PublicCloudRequest
  { rMethod  :: NH.Method   -- ^ Method of AzureIPRangesAndServiceTags-PublicCloudRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of AzureIPRangesAndServiceTags-PublicCloudRequest
  , rParams   :: Params -- ^ params of AzureIPRangesAndServiceTags-PublicCloudRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept) NH.Method
rMethodL f AzureIPRangesAndServiceTags-PublicCloudRequest{..} = (\rMethod -> AzureIPRangesAndServiceTags-PublicCloudRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f AzureIPRangesAndServiceTags-PublicCloudRequest{..} = (\rUrlPath -> AzureIPRangesAndServiceTags-PublicCloudRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept) Params
rParamsL f AzureIPRangesAndServiceTags-PublicCloudRequest{..} = (\rParams -> AzureIPRangesAndServiceTags-PublicCloudRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f AzureIPRangesAndServiceTags-PublicCloudRequest{..} = (\rAuthTypes -> AzureIPRangesAndServiceTags-PublicCloudRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept -> param -> AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept -> param -> AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept -> param -> AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** AzureIPRangesAndServiceTags-PublicCloudRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = AzureIPRangesAndServiceTags-PublicCloudRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept
  -> [NH.Header]
  -> AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept
...
removeHeader :: AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept -> [NH.HeaderName] -> AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept -> AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept -> AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept
...
addForm :: AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept -> WH.Form -> AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept -> NH.Part -> AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept
...
_setBodyBS :: AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept -> B.ByteString -> AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept -> BL.ByteString -> AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept -> P.Proxy authMethod -> AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept
    -> IO (AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> AzureIPRangesAndServiceTags-PublicCloudConfig
  -> IO (AzureIPRangesAndServiceTags-PublicCloudRequest req contentType res accept)
_applyAuthMethods req config@(AzureIPRangesAndServiceTags-PublicCloudConfig {configAuthMethods = as}) =
  foldlM go req as
  where
