...
------------ | ------------- | ------------- | -------------
*OpenAPIClient.APIs.DefaultApi* | [**GetAzureIpRangesServiceTagsPublicCloud**](DefaultApi.md#getazureiprangesservicetagspubliccloud) | **GET** /ServiceTags_Public_{version}.json | Get Azure IP Ranges and Service Tags - Public Cloud


## Documentation For Models

 - [OpenAPIClient.Models.Change](Change.md)
 - [OpenAPIClient.Models.Value](Value.md)
 - [OpenAPIClient.Models.ValueProperties](ValueProperties.md)
