...
- API version: 1.0.1-pre.0
  - Build date: 2026-08-24T12:15:53.734273260Z[Etc/UTC]
...
```groovy
  ...
  dependencies {
     implementation "com.github:openapiazureipranges:1.0.1-pre.0"
  }
```
...
* `target/openapiazureipranges-1.0.1-pre.0.jar`
* `target/lib/*.jar`
