 ...
 * Change
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", date = "2026-01-31T02:43:42.769916388Z[Etc/UTC]", comments = "Generator version: 7.18.0")
public class Change {
  ...
  public Change changeNumber(@javax.annotation.Nullable Integer changeNumber) {
  ...
  public Change cloud(@javax.annotation.Nullable String cloud) {
    this.cloud = cloud;
    return this;
  }
  ...
  public Change values(@javax.annotation.Nullable List<Value> values) {
    this.values = values;
    return this;
  }
  ...
  public void setValues(@javax.annotation.Nullable List<Value> values) {
    this.values = values;
  }
