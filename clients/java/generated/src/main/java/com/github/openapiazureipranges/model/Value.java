...
public class Value {
  ...
  public Value name(@javax.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
  ...
  public Value id(@javax.annotation.Nullable String id) {
    this.id = id;
    return this;
  }
  ...
  public Value properties(@javax.annotation.Nullable ValueProperties properties) {
  ...
  public void setProperties(@javax.annotation.Nullable ValueProperties properties) {
    this.properties = properties;
  }
  ...
  static {
    ...
    openapiFields = new HashSet<String>(Arrays.asList("name", "id", "properties"));
