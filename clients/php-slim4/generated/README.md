# php-base - PHP Slim 4 Server library for Azure IP Ranges and Service Tags - Public Cloud
...
* OpenAPIServer\Model\Change
* OpenAPIServer\Model\Value
* OpenAPIServer\Model\ValueProperties
