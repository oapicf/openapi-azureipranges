...
class ValueProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ValueProperties';
     ...
     * @return self
     */
    public function setSystemService($system_service)
    {
     ...
     * @return string[]|null
     */
    public function getAddressPrefixes()
    {
     ...
     * @return self
     */
    public function setAddressPrefixes($address_prefixes)
    {
     ...
     * @return string[]|null
     */
    public function getNetworkFeatures()
    {
     ...
     * @return self
     */
    public function setNetworkFeatures($network_features)
    {
