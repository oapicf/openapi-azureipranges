...
java -jar "<path>/openapi-generator/modules/openapi-generator-cli/target/openapi-generator-cli.jar" generate `
    ...
    --git-host "github.com" `
    --git-repo-id "openapi-azureipranges" `
    --git-user-id "oapicf" `
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            GetAzureIpRangesServiceTagsPublicCloudApiResponse apiResponse = await api.GetAzureIpRangesServiceTagsPublicCloudAsync("todo");
            Change model = apiResponse.Ok();
        }
...
## Api Information
- appName: Azure IP Ranges and Service Tags - Public Cloud
- appVersion: 0.10.1-pre.0
...
- gitHost: github.com
- gitRepoId: openapi-azureipranges
- gitUserId: oapicf
- hideGenerationTimestamp: true
- interfacePrefix: I
- library: generichost
...
- packageCopyright: No Copyright
- packageDescription: A library generated from a OpenAPI doc
- packageGuid: {25750224-8737-4B4F-BCB7-2FEA0AC81215}
- packageName: Org.OpenAPITools
- packageTags: 
- packageTitle: OpenAPI Library
- packageVersion: 1.0.0
