...
class ValueProperties(Model):
    ...
    def __init__(self, change_number=None, region=None, region_id=None, platform=None, system_service=None, address_prefixes=None, network_features=None):  # noqa: E501
