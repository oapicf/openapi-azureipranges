...
const azureipranges = require('openapi_azureipranges');
const api = new azureipranges.DefaultApi();

describe('azureipranges', function() {
  describe('without format', function() {
    it('should return IP address in plain text', function(done) {
      var callback = function(error, data, response) {
        ...
        // see https://github.com/cliffano/openapi-azureipranges/issues/13
